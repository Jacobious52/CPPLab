...
int StringUtils::string_height(std::string instring)
{
    vstring lines = split(instring, "\n");
    return lines.size();
}

int StringUtils::string_width(std::string instring)
{
    size_t count = 0;
...
std::string StringUtils::replace_all(std::string instring,
                                     std::string from,
                                     std::string to)
{
    size_t i = 0;
...
std::string StringUtils::readall(std::string filename)
{
...
vstring StringUtils::readlines(std::string filename)
{
    vstring lines;
    std::string line;
    std::ifstream file(filename.c_str());
...
vstring StringUtils::tokens(std::string instring, std::string del)
{
    vstring parts;
...
vstring StringUtils::split(std::string instring, std::string del)
{
    vstring parts;
...
void StringUtils::_recSplit(std::string instring, vstring &parts,
...
std::string StringUtils::trim(std::string instring, std::string whitespaces)
{
    return ltrim(rtrim(instring, whitespaces), whitespaces);
}

std::string StringUtils::ltrim(std::string instring, std::string whitespaces)
{
...
std::string StringUtils::rtrim(std::string instring, std::string whitespaces)
{
...
std::string StringUtils::trim(std::string instring)
{
